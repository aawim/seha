...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{url('/').'/client/dist/css/AdminLTE.min.css'}}">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="{{url('/').'/client/dist/css/skins/_all-skins.min.css'}}">
  <!-- iCheck -->
  <link rel="stylesheet" href="{{url('/').'/client/plugins/iCheck/flat/blue.css'}}">
...
<!-- jQuery 3 -->
<script src="{{url('/').'/client/bower_components/jquery/dist/jquery.min.js'}}"></script>
<!-- Bootstrap 3.3.7 -->
<script src="{{url('/').'/client/bower_components/bootstrap/dist/js/bootstrap.min.js'}}"></script>
<!-- Slimscroll -->
<script src="{{url('/').'/client/bower_components/jquery-slimscroll/jquery.slimscroll.min.js'}}"></script>
<!-- FastClick -->
<script src="{{url('/').'/client/bower_components/fastclick/lib/fastclick.js'}}"></script>
<!-- AdminLTE App -->
<script src="{{url('/').'/client/dist/js/adminlte.min.js'}}"></script>
<!-- iCheck -->
<script src="{{url('/').'/client/plugins/iCheck/icheck.min.js'}}"></script>
<!-- Page Script -->
<script>
  $(function () {
