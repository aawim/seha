...
<div class="main">
  ...
  <div class="row">
    <div class="column">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <a href="{{route('clientProduct.create')}}"><button type="submit" class="btn btn-success">Add New Product</button></a>
                  ...
                  @if ($errors->any())
                      ...
                      <form class="form-horizontal" action="{{route('clientProduct.update',$d->id)}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="column" style="margin-top:50px;"><img src="{{url('/').'/'.$d->image}}" style="width:300px;" ></div>
  </div>
