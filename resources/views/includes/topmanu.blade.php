<div class="header-navigation">
          <ul>
            ...
            <li>
            <a href="{{URL('category')}}" style="color:; font-style:bold;">
            ALL CATEGORY </a>
            </li>
            ...
            <li class="dropdown dropdown100 nav-catalogue">
              <a class="dropdown-toggle" data-toggle="dropdown" data-target="#" href="javascript:;" style="color:orange">
                New
            ...
            <li>
            <a href="{{url('find/free')}}" style="color:red; font-style:bold;">
            FREE!</a>
