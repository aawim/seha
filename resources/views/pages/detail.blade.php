                ...
                <div class="product-page-content">
                  ...
                  <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="Reviews">
                      ...
                      @foreach ($reviews as $count3 => $review)
                      ...
                      <div class="review-item clearfix">
                          ...
                          <div class="review-item-content">
                              ...
                              {{substr($review->description ,0,80)}} 
                               <a type="" class=" " data-toggle="collapse" data-target="#{{$count3}}">More</a> |
                           ...
                           @endif
                            ...
                            <div id="{{$count3}}" class="collapse">
                            {{  substr($review->description ,80, strlen($review->description) ) }} 
                              <a  data-toggle="collapse" data-target="#{{$count3}}" style="text-decoration:none; cursor:pointer;"   > Less </a> 
                            </div>
