...
<!-- styles -->
	<link rel="stylesheet/less" type="text/css" href="{{url('/').'/product/themes/less/bootstrap.less'}}">
    
	<script src="{{url('/').'/product/themes/js/less/less.js'}}" type="text/javascript"></script>
...
<!--  javascript
    ...
    <script src="{{ url('/').'/product/themes/js/jquery-1.8.3.min.js' }}"></script>
    <script src="{{ url('/').'/product/bootstrap/js/bootstrap.min.js' }}"></script>
    <script src="{{ url('/').'/product/themes/js/smart.js' }}"></script>
  </body>
</html>